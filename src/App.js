    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white text-gray-800 font-sans">
      ...
      <header className="bg-blue-600 text-white py-12 shadow-lg">
        <div className="container mx-auto px-4 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2 tracking-tight">Transform Your Health with Fit Check</h1>
          <p className="text-lg md:text-xl mb-6">Ms. Rekha Sharma, MSC in Nutrition</p>
          <a href="#contact" className="bg-white text-blue-700 font-semibold px-6 py-3 rounded-full shadow hover:bg-blue-100 transition">Book a Consultation</a>
        </div>
      </header>
      ...
      <section className="container mx-auto px-4 py-12" id="services">
        <h2 className="text-2xl font-bold mb-6 text-blue-700 text-center">Our Services</h2>
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-blue-100 rounded-lg p-6 shadow hover:shadow-lg transition">
          ...
          <div className="bg-blue-100 rounded-lg p-6 shadow hover:shadow-lg transition">
            <h3 className="font-semibold text-lg mb-2">Lifestyle Modification</h3>
            <p>Guidance for sustainable changes to improve your overall well-being.</p>
          </div>
          <div className="bg-blue-100 rounded-lg p-6 shadow hover:shadow-lg transition">
            <h3 className="font-semibold text-lg mb-2">Nutrition for BP, PCOS, Diabetes</h3>
            <p>Expertise in managing chronic conditions through evidence-based nutrition.</p>
          </div>
          <div className="bg-blue-100 rounded-lg p-6 shadow hover:shadow-lg transition">
            <h3 className="font-semibold text-lg mb-2">Obesity Management</h3>
      ...
      <section className="container mx-auto px-4 py-12" id="achievements">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-4 text-blue-700">Achievements</h2>
          <p className="text-lg mb-2">Over <span className="font-bold text-blue-700">15,000+</span> clients managed</p>
          <div className="flex flex-col md:flex-row justify-center gap-6 mt-4">
            <div className="bg-blue-200 rounded-lg px-6 py-4 font-semibold">Best Nutritionist 2023<br/>American Society of Nutrition</div>
            <div className="bg-blue-200 rounded-lg px-6 py-4 font-semibold">Public Service Award 2024<br/>National Council of Indian Congress</div>
          </div>
        </div>
      </section>

      {/* Problem Statement / Mission Section */}
      <section className="container mx-auto px-4 py-12" id="mission">
      ...
      <section className="container mx-auto px-4 py-12" id="contact">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold mb-4 text-blue-700">Contact & Book Now</h2>
          <form className="flex flex-col gap-4">
            <input type="text" placeholder="Your Name" className="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
            <input type="email" placeholder="Your Email" className="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
            <input type="text" placeholder="Your Mobile" className="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
            <textarea placeholder="Your Message" className="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" rows={4}></textarea>
            <button type="submit" className="bg-blue-600 text-white font-semibold px-6 py-3 rounded shadow hover:bg-blue-700 transition">Send Message</button>
          </form>
      ...
      {/* Footer */}
      <footer className="bg-blue-700 text-white py-6 text-center mt-8">
        <p>&copy; {new Date().getFullYear()} Fit Check. All rights reserved.</p>
      </footer>
    </div>
  );
}
